    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad', models.ForeignKey(help_text='The ad that this message is in reference to.', on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='sales.ad')),
                ('recipient', models.ForeignKey(help_text='The user who is the recipient of the message.', on_delete=django.db.models.deletion.CASCADE, related_name='received_messages', to=settings.AUTH_USER_MODEL)),
